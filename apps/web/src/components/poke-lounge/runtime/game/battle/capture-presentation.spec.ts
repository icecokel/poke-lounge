...
test("한국판 하트골드 ROM의 전투 오브젝트 아카이브를 포획 연출 근거로 기록한다", function testCase() {
...
test("포획 연출은 투척·흡수·낙하·바운스·개별 흔들림·결과 순서로 진행한다", function testCase() {
...
test("볼 흔들림 사이에는 정지 구간이 있고 포획 실패 시 볼과 포켓몬을 복원한다", function testCase() {
