...
**Public release risk is unresolved.** The default standalone Web build does not enforce this audit, but Poke Lounge still has unresolved rights records for Pokémon names/marks, ROM-derived game data and sprite sheets, and third-party-labelled visual and map material.
