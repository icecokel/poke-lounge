...
// 방 수명 · 접속 유지
// 전체 챔피언십 수명은 탐험 시간과 분리한다. 활동으로 무한 연장하지 않는다.
export const POKE_LOUNGE_SESSION_MAX_LIFETIME_MS = 2 * 60 * 60 * 1_000;
...
export const SERVER_ROOM_LIVENESS_INTERVAL_MS = 30_000;
